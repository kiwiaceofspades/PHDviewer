...
public class Student {
	...
	public Student(String[][] headersAndValues) {
		String value = null;
		int valueInt = 0;
		Date valueDate = null;
	...
	/**
	 * Very simple method that isn't very robust. Efts entry must be entered correctly.
	 * @return
	 */
	public boolean isPartTime(){
		return efts.equalsIgnoreCase("Part time");
	}
	...
	public String[] getValues(String[] headers) {
		...
		for (int i = 0; i < headers.length; i++) {
			...
			default:
				...
				System.err.println("Could not find value for header " + header);
				break;
			}
			values[i] = value;
		}
